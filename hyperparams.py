...
train_data_csv = 'metadata_jka_12_train.csv'
val_data_csv = 'metadata_jka_12_val.csv'
test_data_csv = 'metadata_jka_12_test.csv'
test_data_csv_shuf = 'metadata_jka_ref_SAD.csv'
#test_data_csv = 'metadata_jka_test.csv'
checkpoint_path = './checkpoints'
log_directory = 'transformer-tts-phone'
sample_path = './samples_mel'
